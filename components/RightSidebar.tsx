...
export const RightSidebar = (props: RightSidebarProps) => {
  ...
  return (
    <>
      <div
        className={`${props.classes} sidebar flex h-screen flex-col justify-between py-2`}
      >
        ...
        <div className="flex items-center justify-evenly pt-4 pb-2">
          <div className="cursor-pointer transition-all duration-200 hover:-translate-y-1 hover:scale-110">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              strokeWidth={1.5}
          ...
          <div className="cursor-pointer transition-all duration-300 hover:-translate-y-1 hover:scale-110">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              strokeWidth={1.5}
